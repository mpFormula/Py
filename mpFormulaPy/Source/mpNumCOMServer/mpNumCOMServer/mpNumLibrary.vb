...
#Region "Helper Functions"
  ...
  Friend Shared Function HasLibraryNumC() As Double
    ...
    If Result = 0 Then
      'Dim DLLPath As String = CStr(My.Computer.Registry.GetValue("HKEY_LOCAL_MACHINE\SOFTWARE\THF", "DLLPath", Nothing))
      Dim DLLPath As String = RootDir() & "mpNum\Win32\Bin"
...
#End Region
  ...
  Shared Sub New()
    ...
    WriteLine("New NumC 32: ", Result.ToString())
  End Sub
  ...
  Public Shared Sub Init(ByVal mpNumType As Int32, ByRef NumPtr As IntPtr)
  End Sub


  <DllImport("mpNumC.dll", EntryPoint:="mpNum_Clear", CallingConvention:=CallingConvention.Cdecl)> _
  Public Shared Sub mpNum_Clear_(ByRef NumPtr As IntPtr)
  End Sub


  
  Private Declare Function amath_gamma Lib "libAmathDouble.dll" (ByVal x As Double) As Double
  ...
  Public Shared Function GammaAmath(x As Double) As Double
    'If HasLibraryAmath() <> 0 Then Return amath_gamma(x) Else Return 0
  End Function
