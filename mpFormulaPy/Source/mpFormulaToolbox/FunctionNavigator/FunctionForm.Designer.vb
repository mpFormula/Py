	Partial Class FunctionsForm
		...
		Private Sub InitializeComponent()
			...
			'
			Me.viewToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.showManualToolStripMenuItem, Me.remeberLastPositionToolStripMenuItem})
