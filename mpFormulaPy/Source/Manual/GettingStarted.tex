...
The mpFormulaC  Library and Toolbox has a Named Pipes interface to fast multiprecision routines written in C. It can be downloaded as mpFormulaC.zip from 
