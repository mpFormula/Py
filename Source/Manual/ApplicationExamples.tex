...
%Then confidence intervals for the difference of 2 means can be calculated as summarized in Table \ref{TableStudentsttest,2i samples, CI}.
%
%\begin{table}[ht]
%	\centering
%	\begin{tabular}{|l|l|}
...
\begin{equation} \label{eq:TTestPower2irho}
	\widetilde{\rho} = \frac{\mu_1-\mu_0}{\sigma} \text{ and } \delta = \sqrt{N} \widetilde{\rho}.
\end{equation}
