...
'Public Module mpf.Formula
  ...
  Public Class mpci_mat_t


    ' Should be friend as well  
    Public x1 As Object = Nothing
    Friend mpci_mat_tType As Int32 = 4
    ...
    Public Sub New(ByVal x As Object)
      If TypeOf x Is mpci_mat_t Then
        x1 = DirectCast(x, mpci_mat_t).x1
      Else
        x1 = MpAll.Getmpc(x, x)
      End If
    End Sub

    Public Sub New(ByVal x As mpci_mat_t)
      x1 = x.x1
    End Sub


    Public Shared Widening Operator CType(ByVal m1 As mpci_mat_t) As String
      Return m1.Str()
    End Operator


    'Public Shared Narrowing Operator CType(ByVal s As String) As mpci_mat_t
    Public Shared Widening Operator CType(ByVal s As String) As mpci_mat_t
      Return New mpci_mat_t(s, s)
    End Operator


    Public Shared Narrowing Operator CType(ByVal m1 As mpci_mat_t) As Decimal
      Return CDec(m1.Str())
    End Operator

    Public Shared Widening Operator CType(ByVal dec As Decimal) As mpci_mat_t
      Return New mpci_mat_t(CStr(dec))
    End Operator

    '  Public Shared Widening Operator CType(ByVal obj As Object) As mpci_mat_t
    '    Return New mpci_mat_t(obj)
    '  End Operator


    Public Shared Narrowing Operator CType(ByVal m1 As mpci_mat_t) As Double
      Return CDbl(m1.Str())
    End Operator

    Public Shared Widening Operator CType(ByVal d As Double) As mpci_mat_t
      Return New mpci_mat_t(d, d)
    End Operator


    Public Shared Narrowing Operator CType(ByVal m1 As mpci_mat_t) As Long
      Return CLng(m1.Str())
    End Operator

    Public Shared Widening Operator CType(ByVal si As Long) As mpci_mat_t
      Return New mpci_mat_t(CStr(si))
    End Operator



    Public Shared Narrowing Operator CType(ByVal m1 As mpci_mat_t) As ULong
      Return CULng(m1.Str())
    End Operator

    Public Shared Widening Operator CType(ByVal ui As ULong) As mpci_mat_t
      Return New mpci_mat_t(CStr(ui))
    End Operator



    Public Shared Operator =(ByVal m1 As mpci_mat_t, ByVal m2 As mpci_mat_t) As Boolean
      Return m1.x1 = m2.x1
    End Operator


    Public Shared Operator =(ByVal m1 As mpci_mat_t, ByVal obj As Object) As Boolean
      Dim m2 As New mpci_mat_t(obj)
      Return m1.x1 = m2.x1
    End Operator


    Public Shared Operator =(ByVal obj As Object, ByVal m1 As mpci_mat_t) As Boolean
      Dim m2 As New mpci_mat_t(obj)
      Return m2.x1 = m1.x1
    End Operator
    ...
    Public Shared Operator +(ByVal m1 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
      m3.x1 = m1.x1
      Return m3
    End Operator
    ...
    Public Shared Operator +(ByVal m1 As mpci_mat_t, ByVal m2 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
      'MsgBox("Plus_mpci_mat_t")
      m3.x1 = m1.x1 + m2.x1
      Return m3
    End Operator

    Public Shared Operator +(ByVal m1 As mpci_mat_t, ByVal obj As Object) As mpci_mat_t
      Dim m3 As New mpci_mat_t(obj)
      m3.x1 = m1.x1 + m3.x1
      Return m3
    End Operator


    Public Shared Operator +(ByVal obj As Object, ByVal m1 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t(obj)
      m3.x1 = m1.x1 + m3.x1
      Return m3
    End Operator
    ...
    Public Shared Operator &(ByVal m1 As mpci_mat_t, ByVal s As String) As String
      Return m1.Str() & s
    End Operator


    Public Shared Operator &(ByVal s As String, ByVal m1 As mpci_mat_t) As String
      Return s & m1.Str()
    End Operator
    ...
    Public Shared Operator Mod(ByVal m1 As mpci_mat_t, ByVal m2 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
    ...
    Public Shared Operator <<(ByVal m1 As mpci_mat_t, ByVal i As Integer) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
      '    m3.x1 = m1.x1.RSH(i)
      Return m3
    End Operator
    ...
    Public Shared Operator IsTrue(ByVal m1 As mpci_mat_t) As Boolean
    ...
    Public Shared Operator IsFalse(ByVal m1 As mpci_mat_t) As Boolean
      '    Return m1.x1.Is_Zero <> 0
      Return True
    End Operator


    Public Shared Operator Not(ByVal m1 As mpci_mat_t) As Boolean
    ...
    Public Shared Operator And(ByVal m1 As mpci_mat_t, ByVal m2 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
    ...
    Public Shared Operator Or(ByVal m1 As mpci_mat_t, ByVal m2 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
    ...
    Public Shared Operator Xor(ByVal m1 As mpci_mat_t, ByVal m2 As mpci_mat_t) As mpci_mat_t
      Dim m3 As New mpci_mat_t()
